...
namespace WebApp.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public ImagesController(BookRentalDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Images != null ? 
                          ...
                          Problem("Entity set 'BookRentalDBContext.Images'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ImageId,ImageName,Blob,ImageType")] Image image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImageId,ImageName,Blob,ImageType")] Image image)
        {
            if (id != image.ImageId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookRentalDBContext.Images'  is null.");
            }
            var image = await _context.Images.FindAsync(id);
            if (image != null)
            {
